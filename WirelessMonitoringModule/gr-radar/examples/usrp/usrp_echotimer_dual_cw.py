...
# Generated: Thu Feb  8 13:00:23 2018
##################################################
...
class usrp_echotimer_dual_cw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_usrp_echotimer_cc_0 = radar.usrp_echotimer_cc(samp_rate, center_freq, int(delay_samp), 'serial=30F4194', '', 'internal', 'none', 'TX/RX', gain_tx, 0.1, 0.05, 0, 'serial=30F4194', '', 'internal', 'none', 'RX2', gain_rx, 0.1, 0.05, 0, "packet_len")
