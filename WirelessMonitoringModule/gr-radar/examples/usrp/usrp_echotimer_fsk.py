...
# Title: Usrp Echotimer Fsk
# Generated: Wed Jan 31 11:57:02 2018
##################################################
...
class usrp_echotimer_fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_usrp_echotimer_cc_0 = radar.usrp_echotimer_cc(samp_rate, center_freq, int(delay_samp), '', '', 'internal', 'none', 'TX/RX', gain_tx, 0.1, wait_to_start, 0, '', '', 'internal', 'none', 'RX2', gain_rx, 0.1, wait_to_start, 0, "packet_len")
...
def main(top_block_cls=usrp_echotimer_fsk, options=None):
