...
# Title: Simulator Fmcw Rcs
# Generated: Tue Jan 23 11:47:19 2018
##################################################
...
class simulator_fmcw_rcs(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((value_range,), (velocity,), (rcs,), (0,), (0,), samp_rate, center_freq, -10, True, True, "packet_len")
        ...
        self.radar_estimator_rcs_0 = radar.estimator_rcs(10, center_freq, 0, 0, 0, 1, 0.85, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.radar_static_target_simulator_cc_0.setup_targets((self.value_range,), (self.velocity,), (self.rcs,), (0,), (0,), self.samp_rate, self.center_freq, -10, True, True)
...
def main(top_block_cls=simulator_fmcw_rcs, options=None):
