...
# Generated: Tue Feb 13 14:10:17 2018
##################################################
...
class simulator_fmcw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((value_range,), (velocity,), (1e16,), (0,), (0,), samp_rate, center_freq, -10, False, False, "packet_len")
        ...
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.qtgui_sink_x_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.radar_static_target_simulator_cc_0.setup_targets((self.value_range,), (self.velocity,), (1e16,), (0,), (0,), self.samp_rate, self.center_freq, -10, False, False)
        self.qtgui_sink_x_0_1.set_frequency_range(0, self.samp_rate/self.decim_fac)
