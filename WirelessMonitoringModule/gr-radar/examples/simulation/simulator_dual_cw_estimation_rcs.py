...
# Title: Simulator Dual Cw Estimation Rcs
# Generated: Sun Jan 21 12:10:53 2018
##################################################
...
class simulator_dual_cw_estimation_rcs(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simulator Dual Cw Estimation Rcs")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simulator Dual Cw Estimation Rcs")
        ...
        self.settings = Qt.QSettings("GNU Radio", "simulator_dual_cw_estimation_rcs")
        ...
        # Blocks
        ##################################################
        self._vel_range = Range(-50, 50, 0.1, 0, 200)
        ...
        self._rcs_range = Range(0, 100, 1, 5, 200)
        self._rcs_win = RangeWidget(self._rcs_range, self.set_rcs, "rcs", "counter_slider", float)
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((value_range,), (vel, ), (rcs, ), (0,), (0,), samp_rate, center_freq, -10, True, False, "packet_len")
        ...
        self.radar_estimator_rcs_0 = radar.estimator_rcs(1, 2.45e9, 0, 0, 0, 0.5, 4, 0.5)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.radar_static_target_simulator_cc_0.setup_targets((self.value_range,), (self.vel, ), (self.rcs, ), (0,), (0,), self.samp_rate, self.center_freq, -10, True, False)
...
def main(top_block_cls=simulator_dual_cw_estimation_rcs, options=None):
